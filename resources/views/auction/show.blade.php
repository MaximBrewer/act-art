...
<section class="auction-header"
    ...
    <div class="darkener">
        <div class="container">
            ...
            <div class="button"><a href="/auction/{{ $auction->id }}/online" class="btn btn-danger btn-lg" type="button">{{ __("ПРИНЯТЬ УЧАСТИЕ") }}</a></div>
...
<section class="auction-section">
    <div class="container">
        ...
        <div class="waterfall-wrapper">
            <div class="waterfall" data-entity="post" data-action="add" data-preview="waterfall" data-category="blog"
